            ...
            <div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
                <div class="mb-7">
                    ...
                    <p class="text-gray-400">Don't have an account? <a href="{{ route('register') }}"
                            class="text-sm text-purple-700 hover:text-purple-700" wire:navigate>Sign Up</a></p>
                </div>
                    ...
                    <div class="space-y-6">
                        <div class="">
                            <x-text-input id="email"
                                ...
                                type="email" wire:model="form.email" name="email" :value="old('email')" required
                        ...
                        <div class="relative" x-data="{ show: true }">
                            <x-text-input id="password"
                                ...
                                type="password" wire:model="form.password" name="password" required
